...
VOID ChangeScreenV5187(LPVOID BASE_W_ADDR, LPVOID BASE_H_ADDR, LPVOID BASE_W2_ADDR, LPVOID BASE_H2_ADDR, LPVOID BASE_PUZZLE_W_ADDR, LPVOID BASE_PUZZLE_H_ADDR, LPVOID BASE_PUZZLE_H2_ADDR, LPVOID BASE_MAIN_UI0_ADDR, LPVOID BASE_MAIN_UI1_ADDR, LPVOID BASE_ARROW_ADDR, LPVOID BASE_HELP_BUTTON_ADDR) {
...
VOID GUICalculator::ChangeScreenSize(DWORD VERSION) {
	if(VERSION == 5187) {
		...
		ChangeScreenV5187(BASE_W_ADDR, BASE_H_ADDR, BASE_W2_ADDR, BASE_H2_ADDR, BASE_PUZZLE_W_ADDR, BASE_PUZZLE_H_ADDR, BASE_PUZZLE_H2_ADDR, BASE_MAIN_UI0_ADDR, BASE_MAIN_UI1_ADDR, BASE_ARROW_ADDR, BASE_HELP_BUTTON_ADDR);
